...
# It obeys a few simple rules (below) but when it's spoken quickly it's really difficult for
# non-children (and non-native speakers) to understand.
#
...
describe "#translate" do
  ...
  it "translates a word beginning with twoh consonants" do
    s = translate("cherry")
